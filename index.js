...
, source_line = require('./lib/constants').source_line
, end_of_source = require('./lib/constants').end_of_source
, eol = require('./lib/constants').eol
, eof = require('./lib/constants').eof
, util = require('util')
